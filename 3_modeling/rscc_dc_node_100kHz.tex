...
\begin{axis}[%
    ...
    \addplot [semithick,smooth,black]
      table [y=y1] {./3_modeling/rm1_sw_dx_O2.dat};\label{pl_MDL}
    \addplot [semithick,smooth,black!66]
      table [y=y1] {./3_modeling/rm2_sw_dx_O2.dat};
    \addplot [semithick,smooth,black!33]
      table [y=y1] {./3_modeling/rm3_sw_dx_O2.dat};

    \addplot [semithick,smooth,black,dashed]
      table [y=y1] {./3_modeling/rm1_ms_sw_dx_O2.dat};\label{pl_MDL}
