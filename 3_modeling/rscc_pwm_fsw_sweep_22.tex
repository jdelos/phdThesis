...
\addplot [semithick,mark=square,only marks,black]
  table [y=y5]{./3_modeling/rx_sw_fsw_O1.dat};
\addplot [semithick,smooth,black]
  table [y=y5]{./3_modeling/rm1_sw_fsw_O1.dat};
\addplot [semithick,smooth,black!66]
  table [y=y5]{./3_modeling/rm2_sw_fsw_O1.dat};
\addplot [semithick,smooth,black!33]
  table [y=y5]{./3_modeling/rm3_sw_fsw_O1.dat};
...
\addplot [semithick,mark=star,only marks,black]
  table [y=y5]{./3_modeling/err1_sw_fsw_O1.dat};
