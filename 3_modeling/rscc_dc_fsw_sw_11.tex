...
\addplot [semithick,mark=square,only marks,black]
  table [y=y]{./3_modeling/rx_sw_fsw_O2.dat};\label{pl_PLECS}

\addplot [semithick,smooth,black]
  table [y=y1]{./3_modeling/rm1_sw_fsw_O2.dat};\label{pl_MDL}
  \addlegendentry{}

\addplot [semithick,smooth,black!66]
  table [y=y1]{./3_modeling/rm2_sw_fsw_O2.dat};

\addplot [semithick,smooth,black!33]
  table [y=y1]{./3_modeling/rm3_sw_fsw_O2.dat};
